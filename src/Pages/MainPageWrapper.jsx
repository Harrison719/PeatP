...
const InstrumentWrapper = props => {
  ...
  return (
    <div>
      ...
      <Grid item xs={2} className={classes.linkClass} ><a onClick={()=>openModal({open:true, modalType:'Wishlist', data:{}})}>Process</a></Grid>
      ...
      <Grid item xs={2} className={classes.linkClass} ><a onClick={()=>openModal({open:true, modalType:'Wishlist', data:{}})}>Contact</a></Grid>
      <Grid item xs={2} className={classes.linkClass} ><a onClick={()=>openModal({open:true, modalType:'Wishlist', data:{}})}>Blog</a></Grid>
      </Grid>
      <Grid container>
      ...
      <Grid item xs={3}><div className={classes.marginTopBottom30}><a onClick={()=>openModal({open:true, modalType:'Wishlist', data:{}})}><Box className={classes.contactBox}>Call Michael</Box></a></div>
      </Grid>
      </Grid>
